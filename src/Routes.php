...
return [
    ...
    // Faculty.
    ['GET',  '/faculty/{id:\d}',                 ['MINI\Controllers\FacultyHome', 'display']],
    //  Reserve
    ['GET',  '/faculty/{id:\d}/reservation/add',             ['MINI\Controllers\ReservationAdd', 'display']],
    ['GET',  '/faculty/{id:\d}/reservation/update/{reservation:\d}',  ['MINI\Controllers\ReservationUpdate', 'display']],
    ['GET',  '/faculty/{id:\d}/reservation/delete/{reservation:\d}',  ['MINI\Controllers\ReservationDelete', 'display']],
    ['POST', '/faculty/{id:\d}/reservation/add',             ['MINI\Controllers\ReservationAdd', 'add']],
    ['POST', '/faculty/{id:\d}/reservation/update/{reservation:\d}',  ['MINI\Controllers\ReservationUpdate', 'update']],
    ['POST', '/faculty/{id:\d}/reservation/delete/{reservation:\d}',  ['MINI\Controllers\ReservationDelete', 'delete']],
    //  Checkout
    ['GET',  '/faculty/{id:\d}/checkout/{reservation:\d}', ['MINI\Controllers\FacultyCheckout', 'display']],
    ['POST', '/faculty/{id:\d}/checkout',         ['MINI\Controllers\FacultyCheckout', 'checkout']],
    ['GET',  '/faculty/{id:\d}/checkin/{reservation:\d}',  ['MINI\Controllers\FacultyCheckin', 'display']],
    ['POST', '/faculty/{id:\d}/checkin',          ['MINI\Controllers\FacultyCheckin', 'checkin']],
    // Mechanics.
